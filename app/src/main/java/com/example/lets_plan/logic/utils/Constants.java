...
public class Constants {
    ...
    public static final long ANIMATION_DURATION_IN_MS = 5000;
    public static final int BACK_PRESSED_TIME_INTERVAL = 2000;
    public static final String CURRENT_EVENT_HALL = "CURRENT_EVENT_HALL";
    ...
    public static final String NOT_ENOUGH_SEATS_IN_TABLE = "There are not enough seats in this table";
    public static final String OTHER_CATEGORY = "Other";
    public static final String REGISTERED_SUCCESSFULLY = "Registered successfully";
    public static final String REGISTRATION_FAILED = "Registration failed";
    public static final String SEARCH_QUERY = "אולמות+אירועים";
    public static final int SEARCH_RADIUS_IN_METERS = 10000;
    public static final int SMS_PERMISSION_ID = 45;
    public static final String SP_FILE_NAME = "LETS_PLAN_SP";
    ...
    public static final String EVENT_HALL_COLLECTION = "Event_Hall";
    public static final String DATE_AND_TIME_COLLECTION = "Event_Date";
}
